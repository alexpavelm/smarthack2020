...
List<CategoryModel> categories = [
  CategoryModel(
    ...
    image: "assets/images/fruit_essentials.jpg",
    subtitle: "For that inner sweet tooth",
  ),
  CategoryModel(
    ...
    subtitle: "A taste of green & healthy",
  ),
  CategoryModel(

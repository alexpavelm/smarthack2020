...
class LoginScreen extends StatefulWidget {
  ...
  const LoginScreen({Key key, this.bloc}) : super(key: key);
  @override
    ...
    return Scaffold(
      body: BlocListener<AuthenticationBloc, AuthenticationState>(
        ...
        listener: (context, state) {
          if (state is AuthenticatedOnBoard) {
                    ...
                    children: <Widget>[
                      ...
                      Row(
                        children: [
                          ...
                          Text(
                            "j",
                            style: AppStyle.appTitle.copyWith(
                                color: AppColor.lightGreen, height: 0.8),
                          ),
                          Text(
                            "oo",
                            style: AppStyle.appTitle.copyWith(height: 0.8),
                      ...
                      Row(
                        children: [
                          ...
                          Text(
                            ".",
                            style: AppStyle.appSubtitle
                                .copyWith(color: AppColor.lightGreen, height: 1),
                          ),
                        ],
                      ),
                      Row(
                        ...
                        children: [
                          state is LoggingIn
                            ...
                            height: adaptiveHeight(80),
                                  child: CircularProgressIndicator(valueColor: new AlwaysStoppedAnimation<Color>(AppColor.lightGreen),),
                                )
                              : verticalSpace(80),
                        ],
                      ),
                      Padding(
                        padding: EdgeInsets.only(
                            left: adaptiveWidth(220), right: adaptiveWidth(220)),
                        child: Column(
                          children: [
                            Column(
                              children: <Widget>[
                            ...
                            Text(
                              'or',
                              style: AppStyle.whiteSmallText.copyWith(
